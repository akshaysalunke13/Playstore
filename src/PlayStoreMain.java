public class PlayStoreMain {
        ...
        public static void main(String[] args) {
                ...
                Book b1 = new Book ("r1", "War and Peace", 12000, "The Russian Messenger", "Novel", 1225, authors1);
                ...
                try {
                	System.out.println("User 1 buying book 1");
					u1.buyContent(b1);
                ...
                try {
                	System.out.println("User 1 buying book 3");
					u1.buyContent(b3);
				} catch (insufficientFundException e) {
					// TODO Auto-generated catch block
					System.out.println(e);
                ...
                try {
                	System.out.println("User 1 buying m1");
					u1.buyContent(m1);
				} catch (insufficientFundException e) {
					// TODO Auto-generated catch block
					System.out.println(e);
                ...
                try {
                	System.out.println("User 1 buying G1");
					u4.buyContent(g1);
				} catch (insufficientFundException | OSMismatchException | OSVersionException e) {
					// TODO Auto-generated catch block
					System.out.println(e);
				}
